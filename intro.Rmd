...
- The parameter  $\beta_1$ has an interpretation as the mean increase of the outcome as the regressor increases with one unit. 
...
$$ 
\mathbf{u}_1^T \mathbf{e} = \left[\begin{array}{cc} 1&0\end{array}\right] \left[\begin{array}{c} e_1\\e_2\end{array}\right] = 1\times e_1 + 0 \times e_2 = e_1
$$
2. Projection of error on y-axis 
$$ 
\mathbf{u}_2^T \mathbf{e} = \left[\begin{array}{cc} 1&0\end{array}\right] \left[\begin{array}{c} e_1\\e_2\end{array}\right] = 0\times e_1 + 1 \times e_2 = e_2
$$
3. Projection of error on itself 

$$
\mathbf{e}^T \mathbf{e} =\left[\begin{array}{cc} e_1&e_2\end{array}\right] \left[\begin{array}{c} e_1\\e_2\end{array}\right]=e_1^2+e_2^2
$$

Pythagorean theorem
 $\rightarrow \Vert e \Vert^2_2=e_1^2+e_2^2$ 
