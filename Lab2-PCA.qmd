...
scale on which both should be measured is no longer clear, since neither kilograms can be converted
...
PC2 orthogonal and pointing in the direction of second greatest variability.
...
##### 2. Make a biplot using the retained PCs and interpret. Is there a relationship between vicinity to the river and pollution with certain metals? {.unnumbered}
