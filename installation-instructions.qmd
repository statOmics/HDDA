...
Students are required to bring their own laptop with **R version 4.6** or greater.

Please make sure that your computer’s hardware is sufficiently powered (>8 GB RAM, > 10 GB free disk space), that you have a working wireless card, and that you have administrator rights.

### Local installation

1. Install R version 4.6 or greater from [CRAN](https://cran.r-project.org)
