...
library(GGally)
library(mclust)
clPairs(diabetes[,-1], diabetes$class)
```
...
```{r}
clPairs(diabetes[,-1], diabetes$class, main = "Real")
clPairs(diabetes[,-1], diabetesKmeans$cluster,colors = c(2,3,4),symbols = c(0,17,16), main="K-means")
```
...
```{r} 
diabetesSingle <- agnes(diabetes[,-1], method = "single")
plot(diabetesSingle, label = as.double(diabetes$class), which.plots = 2, main="single")
diabetesComplete <- agnes(diabetes[,-1], method = "complete")
plot(diabetesComplete, which.plots = 2,label = as.double(diabetes$class), main="complete")
diabetesAverage <- agnes(diabetes[,-1], method = "average")
plot(diabetesAverage, which.plots = 2, label = as.double(diabetes$class), main = "average")
```
